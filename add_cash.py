...
class LoginDialog2(QDialog):
    ...
    def __init__(self):
        ...
        self.login_button = QPushButton("Add Cash")
        self.login_button.setStyleSheet("padding: 10px; background-color: #3498db; color: white; font-weight: bold; font-size: 30px;")
        layout.addWidget(self.password_label)
        layout.addWidget(self.login_button)
        self.login_button.clicked.connect(self.add_cash)
