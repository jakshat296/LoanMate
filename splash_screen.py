...
"}")
        ...
        self.label_title.setStyleSheet(u"color: rgb(19, 142, 248);")
...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"LOAN MATE", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created By</strong>: Akshat Jain", None))
    # retranslateUi
